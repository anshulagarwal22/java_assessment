...
current date and time 10 times, with 100 Mili seconds interval - use sleep() method for this interval.
Create a class called MyMain, which contains main() method, in which 3 instances of MyCurrentDate threads 
are being run.
*/
